...
with open('../../Final/src_tokenizer_v2.pickle', 'wb') as handle:
...
with open('../../Final/tar_tokenizer_v2.pickle', 'wb') as handle:
...
model.save_weights('../../Final/attention_best_model_v2.h5')
